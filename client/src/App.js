  ...
  const RedirectDashboard = () => {
    if (loggedIn) {
      return userType === "NURSE" ? (
        <Navigate replace to="/nurse-dashboard" />
      ) : (
        <Navigate replace to="/patient-dashboard" />
      );
    } else {
  ...
  return (
    <Router>
      <Routes>
        ...
        <Route
          path="/login"
          element={!loggedIn ? <LoginForm /> : <RedirectDashboard />}
        />
        <Route
          path="/register"
          element={!loggedIn ? <RegisterForm /> : <RedirectDashboard />}
        />
        <Route
        ...
        <Route
          ...
          element={
            <Navigate
              replace
              to={loggedIn ? `/${userType.toLowerCase()}-dashboard` : "/login"}
            />
          }
        />
      </Routes>
